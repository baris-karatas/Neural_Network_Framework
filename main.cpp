...
void test(Network &ark){
    ...
    for(size_t fold=0;fold<10;fold++){
        sprintf(src_add,"/home/blackstone/Desktop/database/testing/%d/",fold);
        cv::glob(src_add,filename);
...
*/
    ...
    for(size_t fold=0;fold<10;fold++){
        std::vector<String>filename;
        sprintf(src_add,"/home/blackstone/Desktop/database/training/%d/",fold);
